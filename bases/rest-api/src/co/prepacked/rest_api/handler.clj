...
(defn login [req]
  (let [login-data (-> req :params :data)]
...
(defn register [req]
  (let [registration-data (-> req :params :data)]
...
(defn add-places-list-feature [req]
  (let [slug (-> req :params :slug)
        places-list-slug (-> req :params :places_list_slug)
        places-list-feature (-> req :params :places_list_feature)]
