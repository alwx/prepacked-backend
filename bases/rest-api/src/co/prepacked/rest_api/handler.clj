...
(defn login [req]
  (let [login-data (-> req :parameters :body)]
...
(defn edit-feature [req]
  (let [feature-id (-> req :parameters :path :feature_id)
        feature-data (-> req :parameters :body)]
...
(defn edit-file [req]
  (let [file-id (-> req :parameters :path :file_id)
        file-data (-> req :parameters :body)]
...
(defn add-places-list-place [req]
  (let [auth-user (-> req :auth-user)
        slug (-> req :parameters :path :slug)
        places-list-slug (-> req :parameters :path :places_list_slug)
        places-list-place (-> req :parameters :body)]
...
(defn add-static-page [req]
  (let [slug (-> req :parameters :path :slug)
        static-page-data (-> req :parameters :path :static_page)]
...
(defn edit-static-page [req]
  (let [slug (-> req :parameters :path :slug)
        static-page-slug (-> req :parameters :path :static_page_slug)
        static-page-data (-> req :parameters :body)]
...
(defn add-navbar-item [req]
  (let [slug (-> req :parameters :path :slug)
        navbar-item-data (-> req :parameters :body)]
...
(defn edit-navbar-item [req]
  (let [slug (-> req :parameters :path :slug)
        navbar-item-id (-> req :parameters :path :navbar_item_id)
        navbar-item-data (-> req :parameters :body)]
