...
(defroutes private-routes
  ...
  (DELETE  "/api/cities/:slug/places_lists/:places_list_slug" [] handler/delete-places-list)
  (POST    "/api/cities/:slug/places_lists/:places_list_slug/places" [] handler/add-places-list-place)
  (PUT     "/api/cities/:slug/places_lists/:places_list_slug/places/:place_id" [] handler/edit-places-list-place)
  (DELETE  "/api/cities/:slug/places_lists/:places_list_slug/places/:place_id" [] handler/delete-places-list-place)
