...
(defroutes private-routes
  ...
  (POST    "/api/cities/:slug/places_lists/:places_list_slug/places" [] handler/add-place)
  (PUT     "/api/cities/:slug/places_lists/:places_list_slug/places/:place_id" [] handler/edit-place)
  (DELETE  "/api/cities/:slug/places_lists/:places_list_slug/places/:place_id" [] handler/delete-place)
